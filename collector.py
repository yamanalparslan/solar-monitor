...
def load_config(fabrika_id: str = "mekanik") -> dict:
    ...
    return {
        ...
        "guc_addr":       int(os.getenv("GUC_ADDR", ayarlar.get("guc_addr", 70))),
        "volt_addr":      int(os.getenv("VOLT_ADDR", ayarlar.get("volt_addr", 71))),
        "akim_addr":      int(os.getenv("AKIM_ADDR", ayarlar.get("akim_addr", 72))),
        "isi_addr":       int(os.getenv("ISI_ADDR", ayarlar.get("isi_addr", 73))),
