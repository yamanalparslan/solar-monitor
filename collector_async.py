...
def load_config(fabrika_id: str = "mekanik") -> dict:
    ...
    return {
        ...
        "guc_addr":       int(ayarlar.get("guc_addr") or os.getenv("GUC_ADDR", 93)),
        "volt_addr":      int(ayarlar.get("volt_addr") or os.getenv("VOLT_ADDR", 29)),
        "akim_addr":      int(ayarlar.get("akim_addr") or os.getenv("AKIM_ADDR", 26)),
        "isi_addr":       int(ayarlar.get("isi_addr") or os.getenv("ISI_ADDR", 44)),
        "guc_scale":      float(ayarlar.get("guc_scale") or os.getenv("GUC_SCALE", 1.0)),
        "volt_scale":     float(ayarlar.get("volt_scale") or os.getenv("VOLT_SCALE", 1.0)),
